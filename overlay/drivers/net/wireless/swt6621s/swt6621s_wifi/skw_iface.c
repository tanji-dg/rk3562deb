...
static void skw_sta_work(struct work_struct *wk)
{
	...
	skw_dbg("inst: %d, state: %s, retry: %d jiff: %d step_start: %d ctx_start: %d auth_start: %d redo:%d not_first:%d\n",
		...
		core->pending.redo, iface->skw->startup_unconn_flag);
